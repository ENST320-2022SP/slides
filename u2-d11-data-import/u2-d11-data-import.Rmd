...
- RStudio Cloud > `AE 09 - Nobels and sales + Data import` > open `nobels-csv.Rmd` and knit.
...
## Option 2 - Format text to snake_case using the `clean_names` function
...
### .hand[Your turn!]
.midi[
- RStudio Cloud > `AE 09 - Nobels and sales + Data import` > `sales-excel.Rmd`. 
