...
This exercise is designed to demonstrate how to resolve merge conflicts in GitHub. 
...
1. Try to avoid merge conflicts to begin with by **always pulling before you do anything else.**
2. Follow the instructions above very carefully when you do get a merge conflict.
